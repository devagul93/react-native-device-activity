  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Total number of times you opened apps
      </Text>
      ...
      <View style={styles.explanationContainer}>
        ...
        <Text style={styles.explanationText}>
          A pickup is counted each time you open an app by tapping its icon. This includes opening from:
        </Text>
        ...
        <Text style={styles.explanationFooter}>
          This metric helps you understand how frequently you check your apps throughout the {getTimeRangeLabel().toLowerCase()}.
        </Text>
      </View>
    </ScrollView>
  );
